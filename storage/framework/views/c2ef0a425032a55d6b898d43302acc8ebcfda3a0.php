    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <!--вывод ошибок -->
                <?php if($errors->any()): ?>
                    ...
                    <?php endif; ?>
        <!--вывод ошибок -->
        <form action="<?php echo e(route('avatar.action', ['id' => $user->user_id])); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="/<?php echo e($user->avatar); ?>" alt="" class="img-responsive" width="200">
                                </div>
