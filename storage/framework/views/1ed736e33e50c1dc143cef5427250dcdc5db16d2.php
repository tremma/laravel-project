            ...
            <div class="row">
                <div class="col-xl-12">
                   <?php if(auth()->check() && Auth::user()->isAdmin()): ?>
                        <a class="btn btn-success" href="<?php echo e(route('create.form')); ?>">Добавить</a>
                    <?php endif; ?>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url(' <?php echo e($user->avatar); ?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="<?php echo e(route ('profile', ['id' => $user->user_id])); ?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo e(route ('edit.form', ['id' => $user->user_id])); ?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="<?php echo e(route('security.form', ['id' => $user->user_id])); ?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                          
                                        <a class="dropdown-item" href="<?php echo e(route ('avatar.form', ['id' => $user->user_id])); ?>">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo e($user->job_title); ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo e($user->phone); ?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo e($user->email); ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo e($user->address); ?></address>
