...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="<?php echo e(route('security.action', ['id' => $user->id])); ?>" method="POST">
        <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo e($user->email); ?>" name="email">
                                </div>
